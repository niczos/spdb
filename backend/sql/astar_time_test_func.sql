...
RETURNS void AS $$
    BEGIN
         EXECUTE format('CREATE TABLE %I AS SELECT *, 90 as max_speed, 0 as heur FROM route_stats_astar_time($1)',
                       route_name||'_Stats') USING route_name||'_best_time_sp_90_heur_0';
					   
		EXECUTE format('INSERT INTO %I SELECT *, 100 as max_speed, 0 as heur FROM route_stats_astar_time($1)',
                       route_name||'_Stats') USING route_name||'_best_time_sp_100_heur_0';
					   
		EXECUTE format('INSERT INTO %I SELECT *, 120 as max_speed, 0 as heur FROM route_stats_astar_time($1)',
                       route_name||'_Stats') USING route_name||'_best_time_sp_120_heur_0';
					   
		EXECUTE format('INSERT INTO %I SELECT *, 140 as max_speed, 0 as heur FROM route_stats_astar_time($1)',
                       route_name||'_Stats') USING route_name||'_best_time_sp_140_heur_0';
					   
		------			   
					   
        EXECUTE format('INSERT INTO %I SELECT *, 140 as max_speed, 1 as heur FROM route_stats_astar_time($1)',
                       route_name||'_Stats') USING route_name||'_best_time_sp_140_heur_1';
					   
		EXECUTE format('INSERT INTO %I SELECT *, 140 as max_speed, 2 as heur FROM route_stats_astar_time($1)',
                       route_name||'_Stats') USING route_name||'_best_time_sp_140_heur_2';
					   
		----			   
					   
		EXECUTE format('INSERT INTO %I SELECT *, 140 as max_speed, 3 as heur FROM route_stats_astar_time($1)',
                       route_name||'_Stats') USING route_name||'_best_time_sp_140_heur_3';
					   
		EXECUTE format('INSERT INTO %I SELECT *, 120 as max_speed, 3 as heur FROM route_stats_astar_time($1)',
                       route_name||'_Stats') USING route_name||'_best_time_sp_120_heur_3';
					   
		EXECUTE format('INSERT INTO %I SELECT *, 100 as max_speed, 3 as heur FROM route_stats_astar_time($1)',
                       route_name||'_Stats') USING route_name||'_best_time_sp_100_heur_3';
					   
		EXECUTE format('INSERT INTO %I SELECT *, 90 as max_speed, 3 as heur FROM route_stats_astar_time($1)',
                       route_name||'_Stats') USING route_name||'_best_time_sp_90_heur_3';		   
		-----			   
					   
		EXECUTE format('INSERT INTO %I SELECT *, 140 as max_speed, 4 as heur FROM route_stats_astar_time($1)',
                       route_name||'_Stats') USING route_name||'_best_time_sp_140_heur_4';
					   
		EXECUTE format('INSERT INTO %I SELECT *, 140 as max_speed, 5 as heur FROM route_stats_astar_time($1)',
				   route_name||'_Stats') USING route_name||'_best_time_sp_140_heur_5';
	 END; $$
LANGUAGE plpgsql;
